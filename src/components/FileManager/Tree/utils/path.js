...
*/
export const isTopOfSubtree = (belowPath, abovePath) =>
...
export const getPathOnLevel = (path, level) =>
  path.slice(0, level);
...
export const isLowerSibling = (a, other) =>
